//
//  JobCareer_jobsearchwrite.swift
//  MainProject
//
...
class JobCareer_jobsearchwrite: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    
    //1
    @IBOutlet weak var workTextfield: UITextField! //근무지 텍스트필드
    @IBOutlet weak var mainJobTextfield: UITextField! //담당업무 텍스트필드
    ...
    @IBOutlet weak var jobTitle: UILabel!  //담당 업무
    
    //2
    @IBOutlet weak var workTextfield2: UITextField! //근무지 텍스트필드
    @IBOutlet weak var mainJobTextfield2: UITextField! //담당업무 텍스트필드
    ...
    @IBOutlet weak var jobTitle2: UILabel!  //담당 업무
    ...
    let times = ["2020/11", "2020/12", "2021/01", "2021/02", "2021/03", "2021/04", "2021/05", "2021/06", "2021/07", "2021/08", "2021/09", "2021/10", "2021/11", "2021/12", "2022/01", "2022/02", "2022/03", "2022/04"]
    let times2 = ["2020/11", "2020/12", "2021/01", "2021/02", "2021/03", "2021/04", "2021/05", "2021/06", "2021/07", "2021/08", "2021/09", "2021/10", "2021/11", "2021/12", "2022/01", "2022/02", "2022/03", "2022/04"]
    let times3 = ["2020/11", "2020/12", "2021/01", "2021/02", "2021/03", "2021/04", "2021/05", "2021/06", "2021/07", "2021/08", "2021/09", "2021/10", "2021/11", "2021/12", "2022/01", "2022/02", "2022/03", "2022/04"]
    let times4 = ["2020/11", "2020/12", "2021/01", "2021/02", "2021/03", "2021/04", "2021/05", "2021/06", "2021/07", "2021/08", "2021/09", "2021/10", "2021/11", "2021/12", "2022/01", "2022/02", "2022/03", "2022/04"]
    var sTime: String?
    var fTime: String?
    var sTime2: String?
    var fTime2: String?
    ...
    @IBAction func clickOneBtn(_ sender: UIButton) {
        ...
        jobTitle.text = mainJobTextfield.text
    ...
    @IBAction func clickTwoBtn(_ sender: UIButton) {
        if(check == false){
            ...
            finishBtn2.transform = CGAffineTransform(translationX: 0, y: +80)
            btnView.isHidden = true
            finBtn.isEnabled = false
        }
        else{
            ...
            jobTitle2.text = mainJobTextfield2.text
            finView2.isHidden = false
            writeView2.isHidden = true
            finishBtn2.isHidden = true
            line.isHidden = false
            line.transform = CGAffineTransform(translationX: 0, y: -275)
            btnView.isHidden = false
            finBtn.isEnabled = true
...
//        }
    ...
    @IBAction func clickFinBtn(_ sender: Any) {
        ...
        var career = titleText.text! + "," + sTime! + " ~ " + fTime! + "," + jobTitle.text!
        
        if(titleText2.text!.count > 1){
            var career2 = " + " + titleText2.text! + "," + sTime2! + " ~ " + fTime2! + "," + jobTitle2.text!
            
            career += career2
        }
        vc.careerInfo = career
