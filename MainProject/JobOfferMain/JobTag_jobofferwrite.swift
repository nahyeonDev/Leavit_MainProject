...
class JobTag_jobofferwrite: UIViewController {
    
    @IBOutlet weak var topView_tag: UIView!
    ...
    @IBAction func clickKey1(_ sender: Any) {
        if(num1[0] == 0){
            key1.setImage(UIImage(named: "jtag1.png"), for: .normal)
            num1[0] += 1
            name1[0] = "편의점"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKey2(_ sender: Any) {
        if(num1[1] == 0){
            key2.setImage(UIImage(named: "jtag2.png"), for: .normal)
            num1[1] += 1
            name1[1] = "카페/커피"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKey3(_ sender: Any) {
        if(num1[2] == 0){
            key3.setImage(UIImage(named: "jtag3.png"), for: .normal)
            num1[2] += 1
            name1[2] = "치킨"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKey4(_ sender: Any) {
        if(num1[3] == 0){
            key4.setImage(UIImage(named: "jtag4.png"), for: .normal)
            num1[3] += 1
            name1[3] = "피자"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKey5(_ sender: Any) {
        if(num1[4] == 0){
            key5.setImage(UIImage(named: "jtag5.png"), for: .normal)
            num1[4] += 1
            name1[4] = "베이커리"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKey6(_ sender: Any) {
        if(num1[5] == 0){
            key6.setImage(UIImage(named: "jtag6.png"), for: .normal)
            num1[5] += 1
            name1[5] = "사무/회계"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKey7(_ sender: Any) {
        if(num1[6] == 0){
            key7.setImage(UIImage(named: "jtag7.png"), for: .normal)
            num1[6] += 1
            name1[6] = "식당/음식점"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKey8(_ sender: Any) {
        if(num1[7] == 0){
            key8.setImage(UIImage(named: "jtag8.png"), for: .normal)
            num1[7] += 1
            name1[6] = "피씨방"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKey9(_ sender: Any) {
        if(num1[8] == 0){
            key9.setImage(UIImage(named: "jtag9.png"), for: .normal)
            num1[8] += 1
            name1[8] = "서비스"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKey10(_ sender: Any) {
        if(num1[9] == 0){
            key10.setImage(UIImage(named: "jtag10.png"), for: .normal)
            num1[9] += 1
            name1[9] = "디자인"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKey11(_ sender: Any) {
        if(num1[10] == 0){
            key11.setImage(UIImage(named: "jtag11.png"), for: .normal)
            num1[10] += 1
            name1[10] = "문화/디자인"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKey12(_ sender: Any) {
        if(num1[11] == 0){
            key12.setImage(UIImage(named: "jtag12.png"), for: .normal)
            num1[11] += 1
            name1[11] = "교육"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKeyy1(_ sender: Any) {
        if(num2[0] == 0){
            keyy1.setImage(UIImage(named: "jtagg1.png"), for: .normal)
            num2[0] += 1
            name2[0] = "gs25"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKeyy2(_ sender: Any) {
        if(num2[1] == 0){
            keyy2.setImage(UIImage(named: "jtagg2.png"), for: .normal)
            num2[1] += 1
            name2[1] = "이디야커피"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKeyy3(_ sender: Any) {
        if(num2[2] == 0){
            keyy3.setImage(UIImage(named: "jtagg3.png"), for: .normal)
            num2[2] += 1
            name2[2] = "스타벅스"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKeyy4(_ sender: Any) {
        if(num2[3] == 0){
            keyy4.setImage(UIImage(named: "jtagg4.png"), for: .normal)
            num2[3] += 1
            name2[3] = "이마트24"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKeyy5(_ sender: Any) {
        if(num2[4] == 0){
            keyy5.setImage(UIImage(named: "jtagg5.png"), for: .normal)
            num2[4] += 1
            name2[4] = "이삭토스트"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKeyy6(_ sender: Any) {
        if(num2[5] == 0){
            keyy6.setImage(UIImage(named: "jtagg6.png"), for: .normal)
            num2[5] += 1
            name2[5] = "롯데리아"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKeyy7(_ sender: Any) {
        if(num2[6] == 0){
            keyy7.setImage(UIImage(named: "jtagg7.png"), for: .normal)
            num2[6] += 1
            name2[6] = "파리바게트"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKkey1(_ sender: Any) {
        if(num3[0] == 0){
            kkey1.setImage(UIImage(named: "jjtag1.png"), for: .normal)
            num3[0] += 1
            name3[0] = "디자이너"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKkey2(_ sender: Any) {
        if(num3[1] == 0){
            kkey2.setImage(UIImage(named: "jjtag2.png"), for: .normal)
            num3[1] += 1
            name3[1] = "교사/선생님"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKkey3(_ sender: Any) {
        if(num3[2] == 0){
            kkey3.setImage(UIImage(named: "jjtag3.png"), for: .normal)
            num3[2] += 1
            name3[2] = "사무직"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKkey4(_ sender: Any) {
        if(num3[3] == 0){
            kkey4.setImage(UIImage(named: "jjtag4.png"), for: .normal)
            num3[3] += 1
            name3[3] = "영업직"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKkey5(_ sender: Any) {
        if(num3[4] == 0){
            kkey5.setImage(UIImage(named: "jjtag5.png"), for: .normal)
            num3[4] += 1
            name3[4] = "번역/통역"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKkey6(_ sender: Any) {
        if(num3[5] == 0){
            kkey6.setImage(UIImage(named: "jjtag6.png"), for: .normal)
            num3[5] += 1
            name3[5] = "청소"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickKkey7(_ sender: Any) {
        if(num3[6] == 0){
            kkey7.setImage(UIImage(named: "jjtag7.png"), for: .normal)
            num3[6] += 1
            name3[6] = "개발자"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
...
extension UIViewController {
    func hideKeyboardtag1() {
        let tap: UITapGestureRecognizer = UITapGestureRecognizer(target: self,
            action: #selector(UIViewController.dismissKeyboard))
        view.addGestureRecognizer(tap)
    }
    @objc func dismissKeyboardtag1() {
