...
class JopSelect_jobofferwrite: UIViewController {
    
    @IBOutlet weak var topView_jobS: UIView!
    ...
    //프랜차이즈, 일반 가게 선택
    @IBOutlet weak var selectBtn1: UIButton! //프랜차이즈
    @IBOutlet weak var selectBtn2: UIButton! //일반가게
    ...
    @IBAction func clickSelectBtn1(_ sender: UIButton) {
        selectBtn1.setImage(UIImage(named: "group848.png"), for: .normal)
    ...
    @IBAction func clickSelectBtn2(_ sender: UIButton) {
        ...
        selectBtn2.setImage(UIImage(named: "group848.png"), for: .normal)
    ...
    @IBAction func clickCafe(_ sender: UIButton) {
        if(num[0] == 0){
            cafe.setImage(UIImage(named: "fillCafe1.png"), for: .normal)
            num[0] += 1
            jCategory[0] = "카페"
    ...
    @IBAction func clickFood(_ sender: UIButton) {
        if(num[1] == 0){
            food.setImage(UIImage(named: "fillFood1.png"), for: .normal)
            num[1] += 1
            jCategory[1] = "음식점"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickSale(_ sender: UIButton) {
        if(num[2] == 0){
            sale.setImage(UIImage(named: "fillSale1.png"), for: .normal)
            num[2] += 1
            jCategory[2] = "유통/판매"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickService(_ sender: UIButton) {
        if(num[3] == 0){
            service.setImage(UIImage(named: "fillService1.png"), for: .normal)
            num[3] += 1
            jCategory[3] = "서비스"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickWrite(_ sender: UIButton) {
        if(num[4] == 0){
            write.setImage(UIImage(named: "fillWrite1.png"), for: .normal)
            num[4] += 1
            jCategory[4] = "사무/회계"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickIt(_ sender: UIButton) {
        if(num[5] == 0){
            it.setImage(UIImage(named: "fillInternet1.png"), for: .normal)
            num[5] += 1
            jCategory[5] = "IT/인터넷"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickCulture(_ sender: UIButton) {
        if(num[6] == 0){
            culture.setImage(UIImage(named: "fillCulture1.png"), for: .normal)
            num[6] += 1
            jCategory[6] = "문화/여가"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickDesign(_ sender: UIButton) {
        if(num[7] == 0){
            design.setImage(UIImage(named: "fillDesign1.png"), for: .normal)
            num[7] += 1
            jCategory[7] = "디자인"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
    ...
    @IBAction func clickStudy(_ sender: UIButton) {
        if(num[8] == 0){
            edu.setImage(UIImage(named: "fillStudy1.png"), for: .normal)
            num[8] += 1
            jCategory[8] = "교육"
            finBtn.isEnabled = true
            finBtn.setImage(UIImage(named: "wj3nextBtn.png"), for: .normal)
